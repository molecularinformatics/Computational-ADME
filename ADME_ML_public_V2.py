...
parser.add_argument("-m", "--model",type=str, default='LightGBM',help="specify the ML algorithms to use "+
                    "The available algorithms is LightGBM, RF, SVM, XGBoost ")
...
if workflow == 'build':
    ...
    if ADME_model == 'RF':
        ...
        print("The ML algorithms should be one of RF, SVM, XGBoost, and LightGBM")
    ...
    validation_result.to_csv('%s_default_validation_result.csv'%ADME_model,index=True, sep=',')
    ...
    if ADME_model == 'RF':
        ...
        f = open('Hyperparameter_for_RF_result.txt','wb')
        ...
        f = open('Hyperparameter_for_SVM_result.txt','wb')
        ...
        f = open('Hyperparameter_for_XGBoost_result.txt','wb')
        ...
        gsearch1.fit(X_train, Y_train)
        f = open('Hyperparameter_for_LightGBM_result.txt','wb')
    ...
    validation_result['Pearson_r_CV'] = [cv_pearson_r]
    validation_result['Pearson_r_test'] = [r_test]
    validation_result.to_csv('%s_Optimized_validation_result.csv'%ADME_model,index=True, sep=',')           
