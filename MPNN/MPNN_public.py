...
# python MPNN_public.py ADME_HLM_train.csv ADME_HLM_test.csv
...
if mode == 'Opt':
    ...
    ## hypopt
    os.system(' --data_path %s --dataset_type regression --metric r2 --num_iters 20 --config_save_path %s_hp.json' %(trainset,sys.argv[1][5:-10]))
    ...
    # hypopt
    os.system('chemprop_hyperopt --data_path %s --dataset_type regression --metric r2 --num_iters 20 --features_generator rdkit_2d_normalized --no_features_scaling --config_save_path %s_hp_rdkit.json' %(trainset,sys.argv[1][5:-10],sys.argv[1][5:-10]))
    ## train and prediction  
    os.system('chemprop_train --data_path %s --dataset_type regression  --features_generator rdkit_2d_normalized --no_features_scaling --metric r2 --config_path %s_hp_rdkit.json --save_dir %s_hp_rdkit_checkpoints' %(trainset,sys.argv[1][5:-10], sys.argv[1][5:-10], sys.argv[1][5:-10]))
